    ...
    <body id="skin-blur-violate">
        <section id="login">
            ...
            <form class="box tile animated active" id="box-login" action='/admin/dologin' method='post'>
                ...
                @endif        
                <input type="text" class="login-control m-b-10" placeholder="Username" name='name' value="admin">
                <input type="password" class="login-control" placeholder="Password" name='pass' value="123456">
                <!-- 请输入验证码： -->
                ...
                <div class='row'>
                    ...
                    <div class='col-xs-4'>
                        <img src="{{ url('/Admin/captch/'.time()) }}" id='img'>
                        <!-- <img src="{{ url('/Admin/captch/'.time()) }}" onclick="this.src='{{ url('/Admin/captch') }}/'+Math.random()" id='img' /> -->
                    </div>
                    <a href='javascript:doDel()'>换一张</a>
                </div>
                <script type="text/javascript">
                    ...
                    function doDel()
                    {
                        ...
                        document.getElementById('img').src='{{ url('/Admin/captch') }}/'+Math.random();
                    }
                </script>
            ...
            <!-- Forgot Password -->
            <form class="box animated tile" id="box-reset" action='/admin/checkuser' method='post'>
                {{ csrf_field() }}
                <h2 class="m-t-0 m-b-15">Check Name</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla eu risus. Curabitur commodo lorem fringilla enim feugiat commodo sed ac lacus.</p>
                <input type="text" name='name' class="login-control m-b-20" placeholder="请输入用户名">    
