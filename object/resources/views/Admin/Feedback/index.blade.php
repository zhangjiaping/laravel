...
@section('content')
	<div class="block-area" id="tableHover">
        <h3 class="block-title">问题反馈信息列表</h3>
        @if(session('msg'))
        ...
        <div class="table-responsive overflow">
        	...
        	<form action='/admin/feedback' method='get'>
        		<div class='medio-body'>
    				问题反馈的标题：<input type='text' class='form-control input-sm m-b-10' name='name'>
    			</div>
                    ...
                    @foreach($list as $v)
                    	<tr>
	                        ...
	                        <td>
	                        	...
	                        	<a class="btn btn-sm btn-alt m-r-5" href='/admin/feedback/{{ $v->id }}/edit'>修改</a>
	                        </td>
	                    </tr>
                    @endforeach
                </tbody>
